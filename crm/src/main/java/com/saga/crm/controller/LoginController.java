...
public class LoginController {
    ...
    @PostMapping("/login")
    public String loginSubmit(@RequestParam String email, @RequestParam String senha, RedirectAttributes attributes) {
        try {
            ...
            attributes.addFlashAttribute("error", "Erro ao tentar fazer login.\nColoque credenciais válidas.");
            return "redirect:/login";
        }
    }
